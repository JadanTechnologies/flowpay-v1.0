...
interface DetailedCashierSalesTableProps {
  sales: Sale[];
}

const DetailedCashierSalesTable: React.FC<DetailedCashierSalesTableProps> = ({ sales }) => {
...
export default DetailedCashierSalesTable;
