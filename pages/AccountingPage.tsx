      ...
      try {
        if (isSupabaseConfigured) {
          ...
          const formattedData = data.map((s: any) => ({
              id: s.id, customerName: s.customer_name, cashierName: s.cashier_name, date: new Date(s.created_at).toISOString(), amount: s.amount, status: s.status, branch: s.branch, items: s.items, payments: s.payments,
          }));
